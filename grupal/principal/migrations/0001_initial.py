# Generated by Django 4.2.1 on 2023-07-04 22:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='principal.cliente')),
                ('direccion_cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='principal.direccioncliente')),
            ],
        ),
        migrations.CreateModel(
            name='DetallePedido',
